        ...
        <div class="form">
            ...
            <div class="form-group">
                ...
                <div class="radio-conteiner">
                    <input id="male-radio" name="sex" type="radio" value="Мужской" v-model="$v.user.sex.$model">
                    <label for="male-radio" class="radio-label">Мужской</label>
                    <input id="female-radio" name="sex" type="radio" value="Женский" v-model="$v.user.sex.$model">
                    <label for="female-radio" class="radio-label">Женский</label>
                </div>
                <div class="message error-message" v-if="!$v.user.sex.required && $v.user.sex.$dirty">Обязательное поле</div>
            </div>
